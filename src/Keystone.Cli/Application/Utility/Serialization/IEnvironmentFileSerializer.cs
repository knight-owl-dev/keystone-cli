...
/// <summary>
/// Defines methods for loading and saving key-value pairs from an environment-style configuration file.
/// </summary>
public interface IEnvironmentFileSerializer
{
    /// <summary>
    /// Loads key-value pairs from an environment-style configuration file.
    /// </summary>
    ...
    /// <summary>
    /// Writes the specified key-value pairs to an environment-style configuration file, preserving existing formatting and comments.
    /// </summary>
    /// <remarks>
